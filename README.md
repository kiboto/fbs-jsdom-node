...
var jsdom = require("fbs-jsdom-node");
...
```js
var jsdom = require("fbs-jsdom-node").jsdom;
...
2. Before creating any documents, you can modify the defaults for all future documents:
  ...
  ```js
  require("fbs-jsdom-node").defaultDocumentFeatures = {
...
```js
var jsdom = require("fbs-jsdom-node").jsdom;
var serializeDocument = require("fbs-jsdom-node").serializeDocument;
